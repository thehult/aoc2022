...
namespace Day11
{
    public class Part2 : AoCSolution
    {
        protected override void AddInputFiles()
        {
            ...
            AddExample("Day11/Example1.txt", "2713310158");
        }
        ...
        protected override object Solve(Input input)
        {
            ...
            var stupidBigDivisorSpentWayTooLongOnThis = monkeys.Aggregate((ulong)1, (a, m) => a * m.Tester);
            ...
            for (var i = 0; i < 10000; i++)
            {
                foreach (var monkey in monkeys)
                {
                    ...
                    { 
                        ...
                        monkeys[nm].Items.Enqueue(newWorry % stupidBigDivisorSpentWayTooLongOnThis);
                        monkey.Inspections++;
                    }
                }
